...
/* package haskell-grep-lite-0.1.0.0 */
#ifndef VERSION_haskell_grep_lite
#define VERSION_haskell_grep_lite "0.1.0.0"
#endif /* VERSION_haskell_grep_lite */
#ifndef MIN_VERSION_haskell_grep_lite
#define MIN_VERSION_haskell_grep_lite(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_grep_lite */
...
#define CURRENT_COMPONENT_ID "haskell-grep-lite-0.1.0.0-inplace-haskell-grep-lite"
